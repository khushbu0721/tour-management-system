...
public class Dashboard extends JFrame implements ActionListener{
   ...
   String username;
    ...
    ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("tour/management/system/icons/dashboard.png"));
  ...
  b1= new JButton("Add Personall Details");
       b1.setBackground( new Color(0,0,102));
       b1.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b2.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b3.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       p2.add(b3);
        ...
        b4= new JButton("Delete Personall Details");
       b4.setBackground( new Color(0,0,102));
       b4.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b5.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b6.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b7.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b8.setFont(new Font("Tamoha", Font.PLAIN,20));
      ...
      b9= new JButton("Book Hotel");
       ...
       b9.setFont(new Font("Tamoha", Font.PLAIN,20));
      ...
      b10= new JButton("View Booked Hotel");
       ...
       b10.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b11.setFont(new Font("Tamoha", Font.PLAIN,20));
      ...
      b12= new JButton("Payment");
       ...
       b12.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b13.setFont(new Font("Tamoha", Font.PLAIN,20));
      ...
      b14= new JButton("Notepad");
       ...
       b14.setFont(new Font("Tamoha", Font.PLAIN,20));
       ...
       b15.setFont(new Font("Tamoha", Font.PLAIN,20));
       b15.setForeground(Color.white);
        b15.setMargin(new Insets(0,0,0,200));
       b15.setBounds(0, 700, 300, 50);
       b15.addActionListener(this);
       p2.add(b15);
       
       
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tour/management/system/icons/home.jpg"));
        ...
        add(l1);
         ...
         JLabel  l4 = new JLabel("Travel and Tourism System");
