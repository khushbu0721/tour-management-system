...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(String username){
       ...
       JLabel l12 = new JLabel(" New Customer Form");
         l12.setBounds(50,0,300,25);
        l12.setFont(new Font("Tohama",Font.PLAIN,25));
        add(l12);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tour/management/system/icons/newcustomer.jpg"));
        Image i2 = i1.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      ImageIcon i3 =new ImageIcon(i2);
        JLabel l11 = new JLabel(i3);
        l11.setBounds(400,40,450,420);
        add(l11);
