...
public class ViewCustomer extends JFrame implements ActionListener {
  ...
  ViewCustomer (String username){
        ...
        l13.setBounds(220,170,150,20);
         add(l13);
        
       
          JLabel l4 = new JLabel(" Name");
        l4.setBounds(30,230,150,35);
         add(l4);
        
        JLabel l14 = new JLabel(" ");
        l14.setBounds(220,230,150,20);
         add(l14);
        
       

        JLabel l5 = new JLabel(" Gender");
        l5.setBounds(30,290,150,35);
         add(l5);
        ...
        l9.setBounds(500,230,150,35);
         add(l9);
         
           JLabel l19 = new JLabel(" ");
        l19.setBounds(690,230,150,20);
         add(l19);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tour/management/system/icons/viewall.jpg"));
        Image i2 = i1.getImage().getScaledInstance(620, 200, Image.SCALE_DEFAULT);
      ImageIcon i3 =new ImageIcon(i2);
        JLabel l20 = new JLabel(i3);
        l20.setBounds(20,400,600,200);
        add(l20);
       
         ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("tour/management/system/icons/viewall.jpg"));
        Image i5 = i4.getImage().getScaledInstance(620, 200, Image.SCALE_DEFAULT);
      ImageIcon i6 =new ImageIcon(i5);
        JLabel l21 = new JLabel(i6);
        l21.setBounds(600,400,600,200);
        add(l21);
